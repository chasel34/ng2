...
**主控(2026-08-23)**:A/B/C 三段模拟器走查完成(`acceptance/functional-checklist.md`),缺陷票 20–34 共 15 张全部修复合并并复验(25 判为假缺陷)。checklist 168 项:通过 136,剩 32 项 —— 31 项「待所有者」(需真实 NGA 登录:签到、版块/主题收藏写、通知、账号切换、用户资料、我的主题/回复、搜索版块等),1 项双指缩放待真机(票 19)。本票转 in-review,等所有者登录验收批完成后 resolved。
