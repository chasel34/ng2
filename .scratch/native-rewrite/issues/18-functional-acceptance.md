...
**主控(2026-08-23)**:A/B/C 三段模拟器走查完成(`acceptance/functional-checklist.md`),缺陷票 20–34 共 15 张全部修复合并并复验(25 判为假缺陷)。checklist 160 项:通过 152,剩 8 项 —— 7 项受账号样本限制(该账号无通知、发帖 0、单账号、不改资料),1 项双指缩放待真机(票 19)。本票转 in-review,等所有者登录验收批完成后 resolved。
